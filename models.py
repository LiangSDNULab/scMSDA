...
class scMSDA(nn.Module):
    def __init__(self, view, input_dim, embedding_dim, cluster_dim, n_clusters,device):
        ...
        # add share_space
        self.mk = torch.nn.Linear(embedding_dim[2] *2, 64, bias=False)  # 1024,64
        self.mv = torch.nn.Linear(64, embedding_dim[2] * 2, bias=False)  # 64,1024
    ...
    def compute_centers(self, x, psedo_labels):
        ...
        return centers
    #动态聚类扩散模块，参数self.temperature_l=0.5
